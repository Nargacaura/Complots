...
static func get_localized_key(type: int) -> String:
	"""
	Static Method: get_localized_key
	
	Static Method to get the localized key of a card by its card_type.
	
	:param int type: Type of the card.
	:return String: Returns the localized key of the card.
	"""
	var name: String = ""
	match type:
		CARD_TYPE.HIDDEN: name = "character.hidden"
		CARD_TYPE.DUKE: name = "character.duke"
		CARD_TYPE.ASSASSIN: name = "character.assassin"
		CARD_TYPE.CONTESSA: name = "character.contessa"
		CARD_TYPE.CAPTAIN: name = "character.captain"
		CARD_TYPE.AMBASSADOR: name = "character.ambassador"
		CARD_TYPE.INQUISITOR: name = "character.inquisitor"
		_: name = "card.invalid"
	return name
